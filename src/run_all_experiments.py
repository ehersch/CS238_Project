...
print("="*80)
print(f"{'Experiment':<25} {'POMDP Total':>12} {'POMDP Sharpe':>12} {'B&H Total':>12} {'B&H Sharpe':>12}")
print("-"*80)

for r in results:
    print(f"{r['name']:<25} {r['pomdp_total']:>12.4f} {r['pomdp_sharpe']:>12.4f} {r['bh_total']:>12.4f} {r['bh_sharpe']:>12.4f}")
